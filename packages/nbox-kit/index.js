...
const KIT_FS_FS = (function() {
  ...
  function calcDirMd5(indir, outfile) {
...
const KIT_RPC_HTTP = (function () {
  ...
  /**
   * @function UrlUpload
   * @description url upload by POST
   */
   ...
   * @description url download by GET
   */
  function UrlDownload(url, savefile, callback = UrlOnError) {
